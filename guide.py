...
with open("./案内データ2020.json", "r", encoding="utf-8") as file:
    guidance_data = json.load(file)

# Retrieve the guidance info based on the sum and direction
guidance_info = guidance_data.get(str(sum_result), {}).get(str(direction), {})
guide_category = guidance_info.get("guide_category", "Unknown")
guide_message = guidance_info.get("guide_info", "Guide info not found.")
reading_message = guidance_info.get("reading_info", None)

print("Sum:", sum_result)
print("Guide Category:", guide_category)
print("Guide Message:", guide_message)
if reading_message:
    print("Reading Message:", reading_message)
